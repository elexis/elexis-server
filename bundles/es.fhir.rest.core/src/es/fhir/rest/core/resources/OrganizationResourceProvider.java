...
public class OrganizationResourceProvider extends AbstractFhirCrudResourceProvider<Organization, IOrganization> {
	...
	public IFhirTransformer<Organization, IOrganization> getTransformer() {
		return transformerRegistry.getTransformerFor(Organization.class, IOrganization.class);
	}
	...
	public List<Organization> search(@OptionalParam(name = Organization.SP_NAME) StringParam name,
		...
		List<Organization> _organizations = contextService.submitContextInheriting(
