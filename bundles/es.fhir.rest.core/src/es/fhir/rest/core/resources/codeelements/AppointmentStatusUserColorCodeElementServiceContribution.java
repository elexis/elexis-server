...
@Component
public class AppointmentStatusUserColorCodeElementServiceContribution implements ICodeElementServiceContribution {
	...
	public String getSystem() {
		return "appointment-status-configured-color";
	}
	...
	private final String PREFIX = "agenda/farben/status/";
