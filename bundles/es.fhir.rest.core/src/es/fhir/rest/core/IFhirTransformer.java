...
/**
 * Service definition for transforming FHIR objects to local Objects. Provides REST CRUD (create,
 * read, update, delete) operations on the local objects using the FHIR objects.
 * 
 * @author thomas
 *
 * @param <F>
...
public interface IFhirTransformer<F, L> {
	...
	/**
	 * Create a new FHIR object representing the localObject, optionally including referenced
	 * resources or considering a {@link SummaryEnum}
	 * 
	 * @param localObject
	 * @param summaryEnum
	 *            the <a href= "https://www.hl7.org/fhir/search.html#summary">summary</a> mode;
	 ...
	 * @param fhirObject
	 * @param localObject
	 * @return the updated local Object, possibly not same as localObject parameter, empty if
	 *         nothing changed
	 */
