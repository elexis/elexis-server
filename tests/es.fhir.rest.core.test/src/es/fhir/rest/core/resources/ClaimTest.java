...
public class ClaimTest {
	...
	public void createClaim() {
		...
		coverage.setType(new Coding(CodingSystem.ELEXIS_COVERAGE_TYPE.getSystem(), "KVG", "Test"));
		...
		claim.addCoverage().setCoverage(new Reference("Coverage/" + coverageOutcome.getId()));
		claim.setProvider(new Reference("Practitioner/" + TestDatabaseInitializer.getMandant().getId()));
		claim.addDiagnosis().setDiagnosis(new Coding(CodingSystem.ELEXIS_DIAGNOSE_TESSINERCODE.getSystem(), "A1", ""));
