...
import info.elexis.server.core.connector.elexis.services.StockCommissioningSystemServiceTest;
...
@SuiteClasses({ ArtikelServiceTest.class, BehandlungServiceTest.class, BillingTest.class, DocHandleServiceTest.class,
		...
		VerrechenbarTest.class, StockServiceTest.class, StockCommissioningSystemServiceTest.class })
